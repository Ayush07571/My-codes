...
def generate_student_data(index):
    ...
    return f"{reg_number},{name},{branch},{dob},{mobile},{email}\n"

# Generate data for 200 students and store it in a file
with open("student_data.txt", "w") as file:
    # First 3 students with specific details
    file.write("REG0001,Ayush Karan,CSE,2000-01-15,8873718596,ayush.karan0001@gmail.com\n")
    file.write("REG0002,Kumar Priyanshu,CSE,2001-02-20,8409701368,kumar.priyanshu0002@yahoo.com\n")
    file.write("REG0003,Anshu Priya,CSE,1999-03-25,9142714797,anshu.priya0003@outlook.com\n")
...
print("Student data has been written to student_data.txt.")
